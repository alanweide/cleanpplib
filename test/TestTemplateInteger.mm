...
typedef t_big_integer<nn_integer> bigint_type;

static std::string bigintToString(bigint_type &o) {
	std::stringstream s;
    s << *o;
    return s.str();
}
...
- (void)testCompareOneZero {
    ...
    std::unique_ptr<big_integer> n2 = std::make_unique<bigint_type>(0);
    std::unique_ptr<big_integer> n1_exp = std::make_unique<bigint_type>(1);
    std::unique_ptr<big_integer> n2_exp = std::make_unique<bigint_type>(0);
...
- (void)testCompareNegFourFive {
    ...
    std::unique_ptr<big_integer> n2 = std::make_unique<bigint_type>(5);
    std::unique_ptr<big_integer> n2_exp = std::make_unique<bigint_type>(5);
    std::unique_ptr<big_integer> n1_exp = std::make_unique<bigint_type>(-4);
