    ...
    while(!p1.is_empty() && !p2.is_empty()){
        ...
        if(p1Card.getCardNum() > p2Card.getCardNum()){
            ...
            if(p1Size >= 3 && p2Size >= 3 ){
                ...
                std::cout<<"p1 has played a "<<tieCards[0]<<", "<<tieCards[2]<<", and "<<p1TieBreaker<<std::endl;
                std::cout<<"p2 has played a "<<tieCards[1]<<", "<<tieCards[3]<<", and "<<p2TieBreaker<<std::endl;
                ...
                if(p1Size < 3){
                    std::cout<<"p1 does not have enough cards to complete the war";
                    while(!p1.is_empty()){
                        p1.dequeue();
                    }
                }
                ...
                if(p2Size < 3){
                    std::cout<<"p2 does not have enough cards to complete the war";
                    while(!p2.is_empty()){
                        p2.dequeue();
                    }
                }
